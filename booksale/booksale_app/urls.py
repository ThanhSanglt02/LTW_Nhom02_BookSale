...
from .views import home_view, product_detail, register_view, login_view, logout_view, order_list, order_detail
...
urlpatterns = [
    ...
    path('emp/order_confirm/<int:pk>', views.order_confirm, name = 'emp/confirm'),
